...
一个个人主页模板，以墨绿为主色，融合图片拼贴、杂志排版与轻量动效，适合展示个人经历、科研成果、项目作品与求职信息，并支持深色模式、双语切换。支持GitHub Pages部署。

<img width="1373" height="854" alt="image" src="https://github.com/user-attachments/assets/95fabaa5-e8db-4458-888c-25f9e75bdabb" />
